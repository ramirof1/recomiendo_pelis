...
* OR, You can also [download](https://downloads.wordpress.org/plugin/hide-featured-image.zip "Download Hide Featured Image") the plugin from the repository. Unzip it and upload it to the plugins folder of your WordPress installation (`wp-content/plugins/` directory of your WordPress installation).
